package com.marcelocbasilio.nearby.ui.component.category
...
import com.marcelocbasilio.nearby.ui.theme.Gray300
import com.marcelocbasilio.nearby.ui.theme.Gray400
import com.marcelocbasilio.nearby.ui.theme.GreenBase
...
private fun NearbyCategoryFilterChipNotSelectedPreview() {
    NearbyCategoryFilterChip(
        category = Category(id = "2", name = "Entretenimento"),
        isSelected = false,
        onClick = {}
    )
}