package com.marcelocbasilio.nearby.core.network

import com.marcelocbasilio.nearby.core.network.KtorHttpClient.httpClientAndroid
import com.marcelocbasilio.nearby.data.model.Category
import com.marcelocbasilio.nearby.data.model.Coupon
import com.marcelocbasilio.nearby.data.model.Market
import com.marcelocbasilio.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_PHYSICAL_BASE_URL = "http://192.168.15.141:3333"
